    ...
    return (
        ...
        <Card sx={{display: "flex", padding: "10px", justifyContent: "space-between"}}>
            ...
            <div className='site-info'>
                ...
                <VisibilityIcon fontSize='small' onClick={() => setShowPass(showPass => !showPass)}></VisibilityIcon>
                </div>
            </div>
            </div>
            <div className='delete-pass-container'>
            <DeleteOutlineIcon color='disabled' sx={{ fontSize: 28 }} onClick={() => console.log("delete pass")}></DeleteOutlineIcon>
            </div>
        </Card>
        </Box>
    )
