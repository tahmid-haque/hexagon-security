...
const encryptedCredentials: CredentialDto[] = [
  ...
  },
  {
    ...
    password: "/gAvXgPnL6/EuDBGfkRSFr1BbhvoHjvFS6k44KTeFGC8GywPxYm4ZWST1Q==",
  ...
  },
  {
    ...
    password: "TqlKe3FD4M7C64lWI5UbVPgaE3Fx9cAdLcH29FSOdC3NPLaEJYqhQBArzBY=",
  ...
  },
  {
    ...
    password: "wAj2hR8Ay49edYa7v7y2rebSOtbocpgOy2tE52eCN6OkTfQ7fwYsSkEag7Q=",
...
class CredentialService {
  ...
  private async calculatePasswordSecurity(
    ...
    try {
      const res = await this.credentialController.checkBreach(hash.slice(0, 5));
  ...
  private async createEncryptedCredential(username: string, password: string) {
  ...
  constructor(
    ...
    this.credentialController = new CredentialController(client, account.jwt);
  }
  ...
  async updateCredential(username: string, password: string, key: ArrayBuffer) {
    const [encryptedUser, encryptedPass] = await this.cryptoWorker.encryptData(
      [username, password],
      key
    );
    // TODO: connect to real api later
